...
план доработки
    BookController - исправить авторАйди на критерию и проверять на наличие ее в сессии
    books.jsp - обработать критерию вместо авторАйди
    AuthorDAOImpl - добавить поиск по имени автора
    добавить фильтр для кнопки чтения книги только для зарегестрированных юзеров
    добавить статистику просмотра книг к юзеру в бд
    добавить цены, корзину, заказы
