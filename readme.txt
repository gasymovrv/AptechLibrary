...
план доработки
    ...
    добавить цены, корзину, заказы
       1 кнопка пополнить - просто +1000 к user.money в контроллере и на ту же страницу;
       2 кнопка изм/уд в корзине - в тот же контроллер, изм - наверно вообще не нужна, уд - удалить book из cart.books;
       3 добавить кнопку очистить в корзине - в тот же контроллер, уд - удалить все из cart.books;
       4 запретить чтение платных книг даже авторизованным юзерам до тех пор пока не купят;
       5 кнопка купить в корзине -
            в тот же контроллер,
       ...
       6 все изм. бд перевести в ликви
