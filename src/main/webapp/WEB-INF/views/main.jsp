...
<div class="col-sm-8">
    <div class="blog-post blog-single-post">
        ...
        <div class="single-post-image">
            <img src="${contextPathToRes}img/blog-large.jpg" alt="Post Title">
        </div>
            ...
            <ul class="post-comments">
                <li>
                    <div class="comment-wrapper">
                        <div class="comment-author"><img src="${contextPathToRes}img/user1.jpg" alt="User Name"> User Name</div>
                        <p>
                ...
                <li>
                    <ul>
                        <li>
                            <div class="comment-wrapper">
                                <div class="comment-author"><img src="${contextPathToRes}img/user2.jpg" alt="User Name"> User Name</div>
                                <p>
                ...
                <li>
                    <div class="comment-wrapper">
                        <div class="comment-author"><img src="${contextPathToRes}img/user5.jpg" alt="User Name"> User Name</div>
                        <p>
